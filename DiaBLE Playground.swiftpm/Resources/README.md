...
If you own an iPad you can just download the [zipped archive](https://github.com/gui-dos/DiaBLE/archive/refs/heads/master.zip) of this repository and open _DiaBLE Playground.swiftpm_.
